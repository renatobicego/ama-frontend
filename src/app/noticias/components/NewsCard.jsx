...
const NewsCard = ({noticia}) => {
    return (
        <Link href={noticia.href} className="w-full xl:w-4/5">
            <div className="flex justify-between items-center w-full font-title text-title gap-2 md:gap-5 lg:gap-8 py-3 xl:py-6 border-y-2">
