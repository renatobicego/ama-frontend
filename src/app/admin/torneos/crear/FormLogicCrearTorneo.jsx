    ...
    >
      ...
      <div className="flex w-full flex-wrap md:flex-nowrap justify-between gap-6">
        ...
        <Select
          color="gray"
          label="Requerir Pago"
          aria-labelledby="requerirComprobante"
          labelProps={{ id: "requerirComprobante" }}
          error={isError("requerirComprobante", formErrors)}
          value={data.requerirComprobante}
          defaultValue={data.requerirComprobante}
          onChange={(value) => handleChange("requerirComprobante", value)}
        >
